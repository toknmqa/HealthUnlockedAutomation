...
//Opens the webdriver selected from the pom file.
public class SeleniumFactory extends Thread {
	...
	public enum BrowserName {
		FIREFOX, GOOGLECHROME, SAUCELABS, OPERA, IE, GRID
	}
			...
			case GRID:
				try {
					DesiredCapabilities capability = DesiredCapabilities
							.firefox();
					aDriver = new RemoteWebDriver(new URL(
							"http://192.168.100.13:4444/wd/hub"), capability);
